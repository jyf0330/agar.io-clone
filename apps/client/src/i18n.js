...
var translations = {
    'zh-CN': {
        ...
        'startMenu.recordConsent': '同意录制本局用于历史回响',
        ...
        'hud.npcRelationships': 'NPC 关系',
        'hud.npcRelationshipValue': '%{name}：%{value}',
        'hud.body': '身体',
        ...
        'signature.title': '画下你的手部签名',
        'signature.subtitle': '参考任意一个回声，用一笔或多笔画出你想装上的手。',
        'signature.missingPart': '缺失部位：手',
        'signature.clear': '清空',
        'signature.submit': '提交签名',
        'signature.skip': '跳过',
        'signature.ref.handOpen': '张开的手',
        'signature.ref.handOpenHint': '稳定、均衡，适合连接。',
        'signature.ref.handGrab': '抓取的手',
        'signature.ref.handGrabHint': '更主动，偏抢夺和交互。',
        'signature.ref.handThread': '牵线的手',
        'signature.ref.handThreadHint': '轻巧，偏游走和牵引。',
        'signature.tier.none': '无回声',
        'signature.tier.faint': '微弱回声',
        'signature.tier.echo': '强回声',
        'signature.message.ready': '画完后提交，系统会给出相似度档位。',
        'signature.message.empty': '先画几笔再提交。',
        'signature.message.saved': '已保存：%{tier}。',
        'signature.message.spectator': '观战模式不会要求绘制签名。',
        ...
        'editor.zoomIn': '放大',
        'editor.layers': '图层',
        'editor.advancedLayers': '高级图层',
        'editor.newImage': '新建图片',
        'editor.saveDraft': '保存到草稿',
        'editor.draftHistory': '历史草稿',
        'editor.noDrafts': '还没有草稿',
        'editor.draftSaved': '已保存到草稿。',
        'editor.draftLoaded': '已载入历史草稿。',
        'editor.emptyDraft': '当前画布为空，无法保存草稿。',
        'editor.newImageFromDraft': '已将当前图片存入草稿，并新建空白图片。',
        'editor.newImageBlank': '已新建空白图片。',
    ...
    'en': {
        ...
        'startMenu.recordConsent': 'Record this round for historical echoes',
        ...
        'hud.npcRelationships': 'NPC Relationships',
        'hud.npcRelationshipValue': '%{name}: %{value}',
        'hud.body': 'Body',
        ...
        'signature.title': 'Draw Your Hand Signature',
        'signature.subtitle': 'Use any echo as a reference and sketch the hand you want to equip.',
        'signature.missingPart': 'Missing part: hand',
        'signature.clear': 'Clear',
        'signature.submit': 'Submit Signature',
        'signature.skip': 'Skip',
        'signature.ref.handOpen': 'Open Hand',
        'signature.ref.handOpenHint': 'Stable and balanced for connection.',
        'signature.ref.handGrab': 'Grabbing Hand',
        'signature.ref.handGrabHint': 'More active, tuned for stealing and contact.',
        'signature.ref.handThread': 'Thread Hand',
        'signature.ref.handThreadHint': 'Light, mobile, and good at pulling.',
        'signature.tier.none': 'No echo',
        'signature.tier.faint': 'Faint echo',
        'signature.tier.echo': 'Strong echo',
        'signature.message.ready': 'Submit after drawing to calculate a similarity tier.',
        'signature.message.empty': 'Draw a few strokes before submitting.',
        'signature.message.saved': 'Saved: %{tier}.',
        'signature.message.spectator': 'Spectator mode does not need a signature.',
        ...
        'editor.advancedLayers': 'Advanced Layers',
        'editor.newImage': 'New Image',
        'editor.saveDraft': 'Save Draft',
        'editor.draftHistory': 'Draft History',
        'editor.noDrafts': 'No drafts yet',
        'editor.draftSaved': 'Saved to drafts.',
        'editor.draftLoaded': 'Loaded draft.',
        'editor.emptyDraft': 'The canvas is empty, so there is nothing to save as a draft.',
        'editor.newImageFromDraft': 'Saved the current image as a draft and created a new blank image.',
        'editor.newImageBlank': 'Created a new blank image.',
