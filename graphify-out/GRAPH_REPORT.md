...
## Corpus Check
- 157 files · ~267,153 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 850 nodes · 1411 edges · 35 communities detected
...
Cohesion: 0.06
Nodes (17): animloop(), enterGame(), resize(), startGame(), createDraftPreviewDataUrl(), drawCircle(), drawLine(), drawRect() (+9 more)
...
Cohesion: 0.06
Nodes (30): getActiveNpc(), getActivePetId(), getPosition(), validNick(), addNew(), Food, removeExcess(), balanceMass() (+22 more)
...
Cohesion: 0.15
Nodes (6): GhostRecorder, sanitizeReplayChat(), rememberRecentChat(), createNpcTaskRewardPart(), grantNpcTaskReward(), recordReward()
...
Cohesion: 0.11
Nodes (15): applyTranslations(), renderPlayerCardPreviews(), renderStatusPanel(), formatBodyStatus(), formatConnectionStatus(), formatGhostDebugStatus(), getStorage(), interpolate() (+7 more)
...
- **Why does `speakPreviousExpectations()` connect `Community 5` to `Community 2`, `Community 10`, `Community 4`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 13` to `Community 11`, `Community 1`, `Community 3`, `Community 5`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `addPlayer()` connect `Community 5` to `Community 0`, `Community 2`, `Community 7`, `Community 10`, `Community 16`?**
