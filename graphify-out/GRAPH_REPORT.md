...
## Corpus Check
- 157 files · ~265,951 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 848 nodes · 1406 edges · 34 communities detected
...
Cohesion: 0.09
Nodes (16): clamp(), randomWalkIntent(), buildPetContext(), buildPetQuestionFallbackReply(), estimatePromptTokens(), getChatFallbackReply(), getDirection(), getMockChatReply() (+8 more)
...
Cohesion: 0.07
Nodes (12): resize(), createDraftPreviewDataUrl(), drawCircle(), drawLine(), drawRect(), drawShape(), Canvas, ChatClient (+4 more)
...
Cohesion: 0.08
Nodes (24): animloop(), applyTranslations(), enterGame(), renderPlayerCardPreviews(), renderStatusPanel(), startGame(), validNick(), createBodySignatureController() (+16 more)
...
- **Why does `speakPreviousExpectations()` connect `Community 4` to `Community 3`, `Community 14`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `addPlayer()` connect `Community 4` to `Community 0`, `Community 7`, `Community 8`, `Community 14`, `Community 16`?**
