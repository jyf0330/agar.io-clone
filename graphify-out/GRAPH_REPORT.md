...
## Corpus Check
- 141 files · ~246,746 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 742 nodes · 1184 edges · 32 communities detected
...
Cohesion: 0.08
Nodes (36): seedSummaries(), buildFallbackImpression(), clampRelationshipValue(), parsePersonaResponse(), shouldUpdateFromSummaryCount(), updateNpcPersona(), updatePersonaImpressions(), finalizeRoundMemoryIfNeeded() (+28 more)

### Community 4 - "Community 4"
Cohesion: 0.09
Nodes (13): animloop(), applyTranslations(), enterGame(), gameLoop(), resize(), startGame(), validNick(), Canvas (+5 more)
...
Cohesion: 0.18
Nodes (14): getAvatarInnerRadius(), shouldUseAvatarRuntimeRender(), cellTouchingBorders(), circlePoint(), drawAvatarCell(), drawCells(), drawCellWithLines(), drawFireFood() (+6 more)
...
- **Thin community `Community 14`** (15 nodes): `recorder.js`, `escapeRegExp()`, `GhostRecorder`, `.canRecordPlayer()`, `.constructor()`, `.getElapsed()`, `.recordChat()`, `.recordCombatEvent()`, `.recordEvent()`, `.recordItem()`, `.recordPartEvent()`, `.recordPlayers()`, `.recordPlayerTrace()`, `loadForbiddenWords()`, `sanitizeReplayChat()`
...
- **Why does `addPlayer()` connect `Community 2` to `Community 0`, `Community 4`, `Community 6`?**
  _High betweenness centrality (0.165) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 11` to `Community 1`, `Community 3`, `Community 5`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `emit()` connect `Community 2` to `Community 4`?**
