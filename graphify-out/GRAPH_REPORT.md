...
## Corpus Check
- 140 files · ~240,004 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 705 nodes · 1100 edges · 30 communities detected
...
Cohesion: 0.1
Nodes (37): applyBodyState(), applySignatureToParts(), cloneBodyPart(), countBodyParts(), createBodyBonuses(), createBodyPart(), createBodyState(), createDefaultBodyParts() (+29 more)
...
- **Why does `addPlayer()` connect `Community 8` to `Community 1`, `Community 2`, `Community 13`?**
  _High betweenness centrality (0.155) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 0` to `Community 3`, `Community 4`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `emit()` connect `Community 8` to `Community 10`, `Community 7`?**
