...
## Corpus Check
- 163 files · ~272,841 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 866 nodes · 1434 edges · 35 communities detected
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 228 edges (avg confidence: 0.8)
...
Cohesion: 0.06
Nodes (33): getActiveNpc(), getActivePetId(), getPosition(), addNew(), Food, removeExcess(), createId(), balanceMass() (+25 more)
...
Cohesion: 0.07
Nodes (28): animloop(), applyTranslations(), enterGame(), renderPlayerCardPreviews(), renderStatusPanel(), resize(), startGame(), validNick() (+20 more)
...
Cohesion: 0.1
Nodes (26): applyBodyState(), applyConnectionState(), clearConnectionState(), createConnectionState(), createStatePatch(), distance(), isEligibleConnectionTarget(), planAttempt() (+18 more)
...
- **Why does `speakPreviousExpectations()` connect `Community 3` to `Community 1`, `Community 11`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 14` to `Community 0`, `Community 2`, `Community 3`, `Community 13`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `addPlayer()` connect `Community 3` to `Community 5`, `Community 8`, `Community 9`, `Community 11`, `Community 17`?**
