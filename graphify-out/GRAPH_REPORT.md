...
## Corpus Check
- 141 files · ~245,161 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 733 nodes · 1162 edges · 31 communities detected
...
Cohesion: 0.06
Nodes (30): getPosition(), addNew(), Food, removeExcess(), balanceMass(), enumerateVisibleWorld(), getVisibleWorldForPlayer(), clamp() (+22 more)
...
- **Why does `addPlayer()` connect `Community 2` to `Community 0`, `Community 8`, `Community 5`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 12` to `Community 1`, `Community 3`, `Community 4`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `emit()` connect `Community 2` to `Community 8`, `Community 7`?**
