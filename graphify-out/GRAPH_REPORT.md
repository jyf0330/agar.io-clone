...
## Corpus Check
- 141 files · ~252,716 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 772 nodes · 1263 edges · 32 communities detected
...
Cohesion: 0.05
Nodes (32): getPosition(), addNew(), Food, removeExcess(), balanceMass(), enumerateVisibleWorld(), getVisibleWorldForPlayer(), clamp() (+24 more)
...
- **Why does `addPlayer()` connect `Community 2` to `Community 8`, `Community 1`, `Community 6`?**
  _High betweenness centrality (0.170) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 11` to `Community 0`, `Community 3`, `Community 12`, `Community 5`?**
