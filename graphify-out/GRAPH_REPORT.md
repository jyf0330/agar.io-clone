...
## Corpus Check
- 147 files · ~257,428 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 801 nodes · 1317 edges · 33 communities detected
...
Cohesion: 0.05
Nodes (29): getPosition(), addNew(), Food, removeExcess(), balanceMass(), enumerateVisibleWorld(), getVisibleWorldForPlayer(), PartLootManager (+21 more)
...
Cohesion: 0.09
Nodes (12): animloop(), applyTranslations(), enterGame(), resize(), startGame(), validNick(), Canvas, ChatClient (+4 more)
...
- **Thin community `Community 10`** (28 nodes): `manager.js`, `distance()`, `eventMatchesMap()`, `GhostManager`, `.activateTrace()`, `.canActivateTrace()`, `.constructor()`, `.getActiveGhostCount()`, `.getDebugState()`, `.getEventKey()`, `.getPartEventPosition()`, `.isAnchorCoolingDown()`, `.isInTimeWindow()`, `.isNearAnyPlayer()`, `.loadChatRecords()`, `.loadPartPickupEvents()`, `.loadTracePoints()`, `.markAnchorTriggered()`, `.pruneGhosts()`, `.spawnGhostPartPickup()`, `.tick()`, `.touchGhostsWithNearbyPlayers()`, `.updateGhostChats()`, `.updateGhostPartPickups()`, `.updateGhostPositions()`, `interpolateTrace()`, `normalizeAnchor()`, `normalizeEvent()`
...
- **Why does `addPlayer()` connect `Community 0` to `Community 1`, `Community 5`, `Community 6`, `Community 14`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 2` to `Community 0`, `Community 4`, `Community 13`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `Orchestrator` connect `Community 4` to `Community 14`?**
