...
## Corpus Check
- 157 files · ~265,364 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 847 nodes · 1404 edges · 33 communities detected
...
Cohesion: 0.08
Nodes (18): clamp(), randomWalkIntent(), buildContextualFallbackUtterance(), pickGreetingFallback(), stableIndex(), buildPetContext(), buildPetQuestionFallbackReply(), estimatePromptTokens() (+10 more)
...
Cohesion: 0.06
Nodes (31): getActiveNpc(), getActivePetId(), getPosition(), addNew(), Food, removeExcess(), balanceMass(), enumerateVisibleWorld() (+23 more)
...
- **Why does `ask()` connect `Community 14` to `Community 0`, `Community 3`, `Community 13`, `Community 7`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `speakPreviousExpectations()` connect `Community 3` to `Community 2`, `Community 12`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `addPlayer()` connect `Community 3` to `Community 1`, `Community 6`, `Community 8`, `Community 12`, `Community 16`?**
