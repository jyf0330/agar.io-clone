...
## Corpus Check
- 144 files · ~254,947 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 786 nodes · 1295 edges · 32 communities detected
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 204 edges (avg confidence: 0.8)
...
Cohesion: 0.07
Nodes (25): getPosition(), addNew(), clamp(), createBehaviorProfile(), hexToHue(), normalizeIntent(), normalizeNpcKey(), NpcState (+17 more)
...
Cohesion: 0.09
Nodes (23): animloop(), applyTranslations(), enterGame(), renderPlayerCardPreviews(), renderStatusPanel(), startGame(), validNick(), createBodySignatureController() (+15 more)
...
Cohesion: 0.11
Nodes (25): buildFallbackImpression(), clampRelationshipValue(), parsePersonaResponse(), shouldUpdateFromSummaryCount(), updateNpcPersona(), updatePersonaImpressions(), buildNpcIntentPrompt(), buildNpcReplyPrompt() (+17 more)
...
- **Thin community `Community 12`** (28 nodes): `manager.js`, `distance()`, `GhostManager`, `.activateTrace()`, `.canActivateTrace()`, `.constructor()`, `.getActiveGhostCount()`, `.getDebugState()`, `.getEventKey()`, `.getEvents()`, `.getPartEventPosition()`, `.isAnchorCoolingDown()`, `.isInTimeWindow()`, `.isNearAnyPlayer()`, `.loadChatRecords()`, `.loadPartPickupEvents()`, `.loadTracePoints()`, `.markAnchorTriggered()`, `.pruneGhosts()`, `.spawnGhostPartPickup()`, `.tick()`, `.touchGhostsWithNearbyPlayers()`, `.updateGhostChats()`, `.updateGhostPartPickups()`, `.updateGhostPositions()`, `interpolateTrace()`, `normalizeAnchor()`, `normalizeEvent()`
...
- **Why does `addPlayer()` connect `Community 4` to `Community 0`, `Community 9`, `Community 5`?**
  _High betweenness centrality (0.171) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 1` to `Community 3`, `Community 11`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `emit()` connect `Community 4` to `Community 9`, `Community 7`?**
