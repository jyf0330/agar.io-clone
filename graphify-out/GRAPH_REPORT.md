...
## Corpus Check
- 140 files · ~243,176 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 720 nodes · 1142 edges · 32 communities detected
...
7. `Canvas` - 13 edges
8. `main()` - 12 edges
9. `createBodyPart()` - 12 edges
10. `emitIfReady()` - 12 edges
...
Cohesion: 0.21
Nodes (4): GhostRecorder, createNpcTaskRewardPart(), grantNpcTaskReward(), recordReward()
...
- **Thin community `Community 11`** (22 nodes): `manager.js`, `partLoot.js`, `distance()`, `GhostManager`, `.activateTrace()`, `.constructor()`, `.getEvents()`, `.isInTimeWindow()`, `.isNearAnyPlayer()`, `.pruneGhosts()`, `.spawnHistoricalItem()`, `.tick()`, `normalizeEvent()`, `canCollectLoot()`, `distance()`, `PartLootManager`, `.addPart()`, `.balanceWorldParts()`, `.collectForPlayer()`, `.constructor()`, `.getSourceType()`, `.normalizePart()`
...
- **Why does `addPlayer()` connect `Community 7` to `Community 0`, `Community 2`, `Community 13`, `Community 5`?**
  _High betweenness centrality (0.151) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 10` to `Community 1`, `Community 3`, `Community 4`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `emit()` connect `Community 7` to `Community 2`?**
