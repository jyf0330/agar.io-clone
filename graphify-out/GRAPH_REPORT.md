...
## Corpus Check
- 140 files · ~243,911 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 726 nodes · 1152 edges · 32 communities detected
...
5. `GhostManager` - 14 edges
6. `addPlayer()` - 13 edges
7. `get()` - 13 edges
8. `Canvas` - 13 edges
9. `main()` - 12 edges
10. `createBodyPart()` - 12 edges
...
Cohesion: 0.1
Nodes (30): seedSummaries(), buildFallbackImpression(), clampRelationshipValue(), parsePersonaResponse(), shouldUpdateFromSummaryCount(), updateNpcPersona(), updatePersonaImpressions(), buildFallbackSummary() (+22 more)
...
Cohesion: 0.11
Nodes (5): PartLootManager, GhostRecorder, createNpcTaskRewardPart(), grantNpcTaskReward(), recordReward()
...
- **Thin community `Community 14`** (16 nodes): `manager.js`, `distance()`, `GhostManager`, `.activateTrace()`, `.canActivateTrace()`, `.constructor()`, `.getActiveGhostCount()`, `.getEventKey()`, `.getEvents()`, `.isAnchorCoolingDown()`, `.isInTimeWindow()`, `.isNearAnyPlayer()`, `.markAnchorTriggered()`, `.pruneGhosts()`, `.tick()`, `normalizeEvent()`
...
- **Why does `addPlayer()` connect `Community 6` to `Community 1`, `Community 3`, `Community 12`, `Community 5`?**
  _High betweenness centrality (0.150) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 10` to `Community 0`, `Community 2`, `Community 4`?**
