...
## Corpus Check
- 158 files · ~267,620 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 854 nodes · 1417 edges · 32 communities detected
...
Cohesion: 0.04
Nodes (45): getActiveNpc(), getActivePetId(), getPosition(), addNew(), Food, removeExcess(), balanceMass(), enumerateVisibleWorld() (+37 more)
...
Cohesion: 0.06
Nodes (38): animloop(), applyTranslations(), enterGame(), gameLoop(), renderPlayerCardPreviews(), renderStatusPanel(), resize(), startGame() (+30 more)
...
- **Thin community `Community 26`** (4 nodes): `clearModule()`, `createOpenAiMockServer()`, `loadWrapperFixture()`, `llm-wrapper.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (3 nodes): `loadConfigWithDemoFlag()`, `loadConfigWithEnv()`, `demo-config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `speakPreviousExpectations()` connect `Community 0` to `Community 11`, `Community 5`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 6` to `Community 0`, `Community 2`, `Community 4`, `Community 12`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `addPlayer()` connect `Community 0` to `Community 1`, `Community 3`?**
