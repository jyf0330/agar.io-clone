...
## Corpus Check
- 114 files · ~103,520 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 559 nodes · 852 edges · 29 communities detected
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 138 edges (avg confidence: 0.8)
...
Cohesion: 0.12
Nodes (32): append(), getAuditFilePath(), resolveAuditDir(), toDateStamp(), createCacheKey(), ensureDatabase(), get(), loadDatabaseLibrary() (+24 more)
...
Cohesion: 0.09
Nodes (15): getPosition(), addNew(), Food, removeExcess(), balanceMass(), enumerateVisibleWorld(), getVisibleWorldForPlayer(), getTotalMass() (+7 more)
...
- **Thin community `Community 16`** (8 nodes): `buildClientJS()`, `buildServer()`, `copyClientAssets()`, `copyClientHtml()`, `getWebpackConfig()`, `gulpfile.js`, `runServer()`, `setDev()`
...
- **Why does `addPlayer()` connect `Community 5` to `Community 1`, `Community 10`, `Community 11`, `Community 7`?**
  _High betweenness centrality (0.185) - this node is a cross-community bridge._
- **Why does `Orchestrator` connect `Community 0` to `Community 11`?**
  _High betweenness centrality (0.173) - this node is a cross-community bridge._
- **Why does `bootstrapNpc()` connect `Community 11` to `Community 5`?**
