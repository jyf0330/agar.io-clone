...
## Corpus Check
- 161 files · ~270,229 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 860 nodes · 1426 edges · 33 communities detected
...
Cohesion: 0.05
Nodes (43): animloop(), applyTranslations(), enterGame(), gameLoop(), renderPlayerCardPreviews(), renderStatusPanel(), resize(), startGame() (+35 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (36): getPosition(), addNew(), Food, removeExcess(), createId(), balanceMass(), enumerateVisibleWorld(), getVisibleWorldForPlayer() (+28 more)
...
Cohesion: 0.07
Nodes (32): getActiveNpc(), getActivePetId(), clamp(), createBehaviorProfile(), hexToHue(), normalizeIntent(), normalizeNpcKey(), NpcState (+24 more)

### Community 8 - "Community 8"
Cohesion: 0.09
Nodes (38): append(), getAuditFilePath(), resolveAuditDir(), toDateStamp(), createCacheKey(), ensureDatabase(), get(), loadDatabaseLibrary() (+30 more)
...
- **Thin community `Community 26`** (4 nodes): `clearModule()`, `createOpenAiMockServer()`, `loadWrapperFixture()`, `llm-wrapper.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (3 nodes): `loadConfigWithDemoFlag()`, `loadConfigWithEnv()`, `demo-config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `speakPreviousExpectations()` connect `Community 7` to `Community 1`, `Community 4`, `Community 14`?**
  _High betweenness centrality (0.138) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 13` to `Community 8`, `Community 3`, `Community 12`, `Community 7`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `addPlayer()` connect `Community 1` to `Community 0`, `Community 2`, `Community 14`, `Community 7`?**
