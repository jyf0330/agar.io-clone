...
## Corpus Check
- 103 files · ~89,800 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 459 nodes · 654 edges · 26 communities detected
...
Cohesion: 0.06
Nodes (27): getPosition(), addNew(), Food, removeExcess(), balanceMass(), enumerateVisibleWorld(), getVisibleWorldForPlayer(), clamp() (+19 more)

### Community 1 - "Community 1"
Cohesion: 0.11
Nodes (21): Cell, changeCellMass(), checkForCollisions(), clientProvidedData(), constructor(), enumerateCollidingCells(), findByID(), findIndexByID() (+13 more)
...
Cohesion: 0.12
Nodes (17): animloop(), applyTranslations(), enterGame(), renderPlayerCardPreviews(), renderStatusPanel(), startGame(), validNick(), formatBodyStatus() (+9 more)

### Community 6 - "Community 6"
Cohesion: 0.14
Nodes (15): applyConnectionState(), clearConnectionState(), createConnectionState(), createStatePatch(), distance(), isEligibleConnectionTarget(), planAttempt(), resolveOutcome() (+7 more)
...
Cohesion: 0.17
Nodes (5): clamp(), randomWalkIntent(), Orchestrator, parseJsonPayload(), buildNpcIntentPrompt()
...
- **Thin community `Community 14`** (8 nodes): `buildClientJS()`, `buildServer()`, `copyClientAssets()`, `copyClientHtml()`, `getWebpackConfig()`, `gulpfile.js`, `runServer()`, `setDev()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 16`** (7 nodes): `game-logic.js`, `massFood.js`, `adjustForBoundaries()`, `addNew()`, `constructor()`, `move()`, `remove()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (5 nodes): `player-card-scale.js`, `canScaleIn()`, `canScaleOut()`, `clampScale()`, `getNextScale()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (4 nodes): `clearModule()`, `createOpenAiMockServer()`, `loadWrapperFixture()`, `llm-wrapper.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `addPlayer()` connect `Community 0` to `Community 1`, `Community 5`, `Community 6`?**
  _High betweenness centrality (0.198) - this node is a cross-community bridge._
- **Why does `Orchestrator` connect `Community 10` to `Community 0`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Are the 5 inferred relationships involving `ask()` (e.g. with `createCacheKey()` and `get()`) actually correct?**
  _`ask()` has 5 INFERRED edges - model-reasoned connections that need verification._
