...
## Corpus Check
- 138 files · ~238,142 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 699 nodes · 1091 edges · 31 communities detected
...
Cohesion: 0.07
Nodes (35): animloop(), applyTranslations(), enterGame(), gameLoop(), renderPlayerCardPreviews(), renderStatusPanel(), resize(), startGame() (+27 more)
...
Cohesion: 0.07
Nodes (19): getPosition(), addNew(), Food, removeExcess(), balanceMass(), enumerateVisibleWorld(), getVisibleWorldForPlayer(), getTotalMass() (+11 more)
...
Cohesion: 0.12
Nodes (35): applyBodyState(), applySignatureToParts(), cloneBodyPart(), countBodyParts(), createBodyBonuses(), createBodyPart(), createBodyState(), createDefaultBodyParts() (+27 more)
...
- **Thin community `Community 14`** (19 nodes): `manager.js`, `partLoot.js`, `distance()`, `GhostManager`, `.activateTrace()`, `.constructor()`, `.getEvents()`, `.isInTimeWindow()`, `.isNearAnyPlayer()`, `.pruneGhosts()`, `.spawnHistoricalItem()`, `.tick()`, `normalizeEvent()`, `canCollectLoot()`, `distance()`, `PartLootManager`, `.addPart()`, `.collectForPlayer()`, `.constructor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (5 nodes): `player-card-scale.js`, `canScaleIn()`, `canScaleOut()`, `clampScale()`, `getNextScale()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (4 nodes): `clearModule()`, `createOpenAiMockServer()`, `loadWrapperFixture()`, `llm-wrapper.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `addPlayer()` connect `Community 2` to `Community 0`, `Community 5`, `Community 6`, `Community 12`, `Community 13`?**
  _High betweenness centrality (0.156) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 11` to `Community 1`, `Community 3`, `Community 4`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `emit()` connect `Community 2` to `Community 0`, `Community 7`?**
