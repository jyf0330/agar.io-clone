...
## Corpus Check
- 213 files · ~1,045,391 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1109 nodes · 1835 edges · 41 communities detected
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 289 edges (avg confidence: 0.8)
...
Cohesion: 0.04
Nodes (51): createLoopHarness(), createPlayer(), createPlayer(), createGameLoopService(), applyMaterializationState(), createMaterializationState(), resolveMaterializationFromBodyParts(), resolveMaterializationStage() (+43 more)

### Community 1 - "Community 1"
Cohesion: 0.06
Nodes (27): getActiveNpc(), getActivePetId(), getPosition(), validNick(), addNew(), Food, removeExcess(), createId() (+19 more)
...
Cohesion: 0.07
Nodes (48): appendPartHistory(), applyBodyState(), applyOwnedPartDefaults(), applySignatureToParts(), cloneBodyPart(), cloneHistoryChain(), cloneShallowObject(), countBodyParts() (+40 more)
...
Cohesion: 0.07
Nodes (48): append(), getAuditFilePath(), resolveAuditDir(), toDateStamp(), createCacheKey(), ensureDatabase(), get(), loadDatabaseLibrary() (+40 more)
...
Cohesion: 0.08
Nodes (26): createDraftPreviewDataUrl(), drawCircle(), drawLine(), drawRect(), drawShape(), createBodyInventoryPanel(), createElement(), createFallbackElement() (+18 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (27): animloop(), applyTranslations(), enterGame(), renderPlayerCardPreviews(), renderStatusPanel(), resize(), startGame(), createBodySignatureController() (+19 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (22): goToNext(), goToPrevious(), makeCurrent(), toggleClass(), createBodyAssemblyPage(), createCharacterPreview(), createPartLayer(), formatFallbackText() (+14 more)
...
Cohesion: 0.11
Nodes (26): buildChatMessages(), executeChatScenario(), main(), buildScenarioOptions(), createDriver(), ensureDir(), finalizeVideo(), httpGet() (+18 more)
...
Cohesion: 0.83
Nodes (3): createCardPreview(), loadBotProfile(), resolveProfilePath()
...
- **Thin community `Community 16`** (28 nodes): `manager.js`, `distance()`, `eventMatchesMap()`, `GhostManager`, `.activateTrace()`, `.canActivateTrace()`, `.constructor()`, `.getActiveGhostCount()`, `.getDebugState()`, `.getEventKey()`, `.getPartEventPosition()`, `.isAnchorCoolingDown()`, `.isInTimeWindow()`, `.isNearAnyPlayer()`, `.loadChatRecords()`, `.loadPartPickupEvents()`, `.loadTracePoints()`, `.markAnchorTriggered()`, `.pruneGhosts()`, `.spawnGhostPartPickup()`, `.tick()`, `.touchGhostsWithNearbyPlayers()`, `.updateGhostChats()`, `.updateGhostPartPickups()`, `.updateGhostPositions()`, `interpolateTrace()`, `normalizeAnchor()`, `normalizeEvent()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (5 nodes): `player-card-scale.js`, `canScaleIn()`, `canScaleOut()`, `clampScale()`, `getNextScale()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (4 nodes): `clearModule()`, `createOpenAiMockServer()`, `loadWrapperFixture()`, `llm-wrapper.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `addPlayer()` connect `Community 1` to `Community 0`, `Community 17`?**
  _High betweenness centrality (0.127) - this node is a cross-community bridge._
- **Why does `speakPreviousExpectations()` connect `Community 1` to `Community 2`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `emit()` connect `Community 1` to `Community 8`, `Community 10`?**
