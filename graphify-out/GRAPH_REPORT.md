...
## Corpus Check
- 109 files · ~96,262 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 495 nodes · 721 edges · 27 communities detected
...
1. `Orchestrator` - 22 edges
2. `ask()` - 15 edges
3. `ChatClient` - 15 edges
4. `Canvas` - 13 edges
...
Cohesion: 0.07
Nodes (23): getPosition(), validNick(), addNew(), Food, removeExcess(), balanceMass(), enumerateVisibleWorld(), getVisibleWorldForPlayer() (+15 more)

### Community 1 - "Community 1"
Cohesion: 0.09
Nodes (26): createCacheKey(), ensureDatabase(), get(), loadDatabaseLibrary(), loadFileCache(), persistFileCacheEntry(), reset(), resolveCachePath() (+18 more)

### Community 2 - "Community 2"
Cohesion: 0.11
Nodes (10): clamp(), randomWalkIntent(), buildContextualFallbackUtterance(), pickGreetingFallback(), stableIndex(), estimatePromptTokens(), Orchestrator, parseJsonPayload() (+2 more)
...
Cohesion: 0.27
Nodes (7): clamp(), createBehaviorProfile(), hexToHue(), normalizeIntent(), normalizeNpcKey(), NpcState, placeNpcNearPlayer()
...
- **Why does `addPlayer()` connect `Community 0` to `Community 3`, `Community 7`?**
  _High betweenness centrality (0.190) - this node is a cross-community bridge._
- **Why does `bootstrapNpc()` connect `Community 0` to `Community 12`?**
  _High betweenness centrality (0.162) - this node is a cross-community bridge._
- **Why does `Orchestrator` connect `Community 2` to `Community 0`?**
