...
## Corpus Check
- 163 files · ~275,087 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 877 nodes · 1450 edges · 34 communities detected
...
Cohesion: 0.07
Nodes (20): animloop(), enterGame(), resize(), startGame(), validNick(), createDraftPreviewDataUrl(), drawCircle(), drawLine() (+12 more)
...
- **Thin community `Community 16`** (14 nodes): `canvas.js`, `Canvas`, `.constructor()`, `.directional()`, `.directionDown()`, `.directionUp()`, `.gameInput()`, `.horizontal()`, `.keyInput()`, `.newDirection()`, `.outOfBounds()`, `.touchInput()`, `.updateTarget()`, `.vertical()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `speakPreviousExpectations()` connect `Community 0` to `Community 1`, `Community 10`?**
  _High betweenness centrality (0.137) - this node is a cross-community bridge._
- **Why does `ask()` connect `Community 4` to `Community 1`, `Community 2`, `Community 12`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `addPlayer()` connect `Community 0` to `Community 10`, `Community 3`, `Community 5`, `Community 14`?**
