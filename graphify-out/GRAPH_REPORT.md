...
## Corpus Check
- 141 files · ~247,461 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 746 nodes · 1195 edges · 33 communities detected
...
2. `ask()` - 18 edges
3. `executeSql()` - 18 edges
4. `ChatClient` - 16 edges
5. `runScenario()` - 15 edges
6. `addPlayer()` - 14 edges
7. `GhostManager` - 14 edges
8. `get()` - 13 edges
9. `GhostRecorder` - 13 edges
10. `Canvas` - 13 edges
...
Cohesion: 0.1
Nodes (28): seedSummaries(), buildFallbackImpression(), clampRelationshipValue(), parsePersonaResponse(), shouldUpdateFromSummaryCount(), updateNpcPersona(), updatePersonaImpressions(), addSessionSummary() (+20 more)
...
- **Thin community `Community 15`** (16 nodes): `recorder.js`, `escapeRegExp()`, `GhostRecorder`, `.canRecordPlayer()`, `.constructor()`, `.getElapsed()`, `.recordChat()`, `.recordChatRecord()`, `.recordCombatEvent()`, `.recordEvent()`, `.recordItem()`, `.recordPartEvent()`, `.recordPlayers()`, `.recordPlayerTrace()`, `loadForbiddenWords()`, `sanitizeReplayChat()`
...
- **Why does `ask()` connect `Community 1` to `Community 2`, `Community 11`, `Community 4`?**
